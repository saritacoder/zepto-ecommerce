    ...
    <footer className="bg-gray-600 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/user/order-history" className="text-gray-300 hover:text-white flex items-center">
                  Order History
                </Link>
              </li>
              <li>
                <Link to="/user/profile" className="text-gray-300 hover:text-white flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=toys" className="text-gray-300 hover:text-white">
                  Toys & Games
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-300">
                <FiMapPin className="mr-2" /> 123 Commerce St, City, State 12345
              </li>
              <li className="flex items-center text-gray-300">
                <FiPhone className="mr-2" /> (123) 456-7890
              </li>
              <li className="flex items-center text-gray-300">
                <FiMail className="mr-2" /> support@swiftmart.com
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">&copy; {currentYear} SwiftMart. All rights reserved.</p>
