...
// category image pe click karne pe open ni ho raha tha usko sahi kar rhai thi but cloudi ai bol raha is page me v change karna hoga so upper change kar rhai
...
const ProductListing = () => {
  ...
  const productsRef = useRef(null) // Add ref for products section
  ...
  const handlePageChange = (pageNumber) => {
    ...
    // Scroll to the products section instead of the top of the page
            ...
            {searchTerm ? (
              ...
              <div className="w-full">
                ...
                {sortedProducts.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" ref={productsRef}>
                ...
                {sortedProducts.length > 0 && totalPages > 1 && (
                  <div className="mt-8 flex justify-center items-center space-x-4">
                    ...
                    <span className="px-4 py-2 rounded-md bg-indigo-600 text-white">
                      {currentPage}
                    </span>
                    <button
                      onClick={() => handlePageChange(currentPage + 1)}
                          ...
                          >
                            <div className="flex flex-col md:flex-row">
                              <Link to={`/products/${product.id}`} className="md:w-1/4">
                                <div className="h-60 md:h-auto overflow-hidden relative">
                                  <img
                                    src={product.imageUrl || "/placeholder.svg?height=192&width=100%"}
                                    alt={product.name}
                                    className="w-full h-full object-contain transition-transform duration-300 hover:scale-110"
...
// below everything is working fine but image pura ni show kar raha
