// // check out ke time addreess fix kar rahi
...
//     if (pincodeRef.current) pincodeRef.current.value = address.zip || ""
//   }
...
//       // Use direct navigation instead of state
...
//                 {/* Show Edit Button when address is selected */}
...
const Checkout = () => {
  ...
  // Updated fillAddressForm to check for both "zip" and "pincode"
  const fillAddressForm = (address) => {
    if (!address) return
    ...
    // Optionally, if you store phone in the address, you can fill it too:
  ...
  // Added a check for e before calling preventDefault
  const handleSubmit = async (e) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-2/3">
            {/* The form still handles shipping and payment details */}
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                <h2 className="text-lg font-medium text-gray-900 mb-4">Shipping Information</h2>
